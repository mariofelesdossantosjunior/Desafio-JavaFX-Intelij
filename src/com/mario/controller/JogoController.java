...
import com.mario.model.Jogador;
import com.mario.model.Personagem;
...
public class JogoController implements Initializable {
    ...
    private void atacarP1(ActionEvent event) {
        ...
        trocaCartas(personUm, personDois, jogadorDois, jogadorUm, "Jogador Um Ganhou!", "Jogador Dois Ganhou!");

    }

    private void trocaCartas(Personagem personUm, Personagem personDois, Jogador jogadorDois, Jogador jogadorUm, String msgVenceUm, String msgVenceDois) throws HeadlessException {
        if (personUm.getForca() > personDois.getDefesa()) {
            ...
            lbGanhador.setText(msgVenceDois);
        } else {
    ...
    private void atacarP2(ActionEvent event) {
        ...
        trocaCartas(personDois, personUm, jogadorUm, jogadorDois, "Jogador Dois Ganhou!", "Jogador Um Ganhou!");
